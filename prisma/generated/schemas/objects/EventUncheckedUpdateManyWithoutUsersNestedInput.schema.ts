...
const Schema: z.ZodType<Prisma.EventUncheckedUpdateManyWithoutUsersNestedInput> = z
  .object({
    create: z
      .union([
...
export const EventUncheckedUpdateManyWithoutUsersNestedInputObjectSchema = Schema
