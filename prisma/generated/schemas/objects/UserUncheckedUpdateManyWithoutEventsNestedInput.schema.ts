...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateManyWithoutEventsNestedInput> = z
  .object({
    create: z
      .union([
...
export const UserUncheckedUpdateManyWithoutEventsNestedInputObjectSchema = Schema
