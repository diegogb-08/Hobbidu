...
const Schema: z.ZodType<Prisma.EventUncheckedCreateNestedManyWithoutUsersInput> = z
  .object({
    create: z
      .union([
...
export const EventUncheckedCreateNestedManyWithoutUsersInputObjectSchema = Schema
