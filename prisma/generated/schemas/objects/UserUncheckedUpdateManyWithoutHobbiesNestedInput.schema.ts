...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateManyWithoutHobbiesNestedInput> = z
  .object({
    create: z
      .union([
...
export const UserUncheckedUpdateManyWithoutHobbiesNestedInputObjectSchema = Schema
